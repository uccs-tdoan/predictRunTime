 ...
 * tri doan
 * other solution use CSVLoader buit-int Weka as follows
 *     java weka.core.converters.CSVLoader iris.csv > iris.arff
 * convert arff inot csv:
 *   java weka.core.converters.CSVSaver -i iris.arff -o iris.csv 
 * Or using read.arff in R (load foreign packages)
 * Oct 11
 * */
...
public class convertCSV_arff {
  ...
  public static void main(String[] args) throws Exception {
    ...
    */
    ...
    String fileName;
	String inPath  = "C:\\algoSelecMeta\\syntheticTest";
   ...
   // loader.setSource(new File(args[0]));
    ...
    saver.setFile(new File("c:\\data\\test\\"+fileName+".arff"));
